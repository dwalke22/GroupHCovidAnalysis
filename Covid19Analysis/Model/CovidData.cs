...
namespace Covid19Analysis.Model
{
    ...
    public class CovidData
    {
        ...
        {
            return
                $"{this.Date.ToShortDateString()} {this.State}: Number of Positive Cases: {this.PositiveCasesIncrease}, Number of " +
                $"Negative Cases: {this.NegativeCasesIncrease}, Deaths: {this.DeathNumbers}, Hospitalized: " +
                $"{this.HospitalizedNumbers}";
        }
