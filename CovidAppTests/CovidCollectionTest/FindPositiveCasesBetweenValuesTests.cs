...
namespace CovidAppTests.CovidCollectionTest
{
    ...
    /// </summary>
    [TestClass]
    public class TestFindNumberOfDaysWithCasesUnderLowerThreshold
    {
        ...
        public void TestEmptyCollection()
        {
            ...
            Assert.ThrowsException<InvalidOperationException>(() => testDataCollection.FindPositiveCasesBetweenValues(1,10));
        }
    }
}